...
# ЗДЕСЬ ВСТРОЕННЫЕ РАСПОКОВЩИКИ

# driver.get("https://demoqa.com/dynamic-properties")
# VISIBLE_AFTER_BUTTON = ("xpath", "//button[@id='visibleAfter']")
# BUTTON1 = wait.until(EC.visibility_of_element_located(VISIBLE_AFTER_BUTTON))
# BUTTON1.click()
#
# driver.get("https://demoqa.com/dynamic-properties")
# ENABLE_AFTER_BUTTON = ("xpath", "//button[@id='enableAfter']")
# BUTTON2 = wait.until(EC.element_to_be_clickable(ENABLE_AFTER_BUTTON))
# BUTTON2.click()
